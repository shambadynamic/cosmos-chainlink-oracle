...
import ShambaGeostatsShambaGeostatsGeostats from './shamba/geostats/shamba.geostats.geostats'
...
export default { 
  ...
  ShambaGeostatsShambaGeostatsGeostats: load(ShambaGeostatsShambaGeostatsGeostats, 'shamba.geostats.geostats'),
