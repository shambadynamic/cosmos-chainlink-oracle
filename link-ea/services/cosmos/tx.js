...
module.exports.protobufPackage = "shamba.geostats.geostats"
...
const MsgCreateData = {
    ...
    toJSON(message) {
        ...
        message.datasetCode !== undefined && (obj.datasetCode = message.datasetCode);
        message.selectedBand !== undefined && (obj.selectedBand = message.selectedBand);
...
module.exports.MsgCreateData = MsgCreateData

const baseMsgCreateDataResponse = { id: 0 };
const MsgCreateDataResponse = {
    encode(message, writer = Writer.create()) {
        if (message.id !== 0) {
...
module.exports.MsgCreateDataResponse = MsgCreateDataResponse
...
module.exports.MsgUpdateData = MsgUpdateData

const baseMsgUpdateDataResponse = {};
const MsgUpdateDataResponse = {
...
module.exports.MsgUpdateDataResponse = MsgUpdateDataResponse
...
module.exports.MsgDeleteData = MsgDeleteData

const baseMsgDeleteDataResponse = {};
const MsgDeleteDataResponse = {
    encode(_, writer = Writer.create()) {
        return writer;
    },
    decode(input, length) {
...
module.exports.MsgDeleteDataResponse = MsgDeleteDataResponse

// const baseMsgRequestData = { creator: "", requester: "", oracle: "" };
...
// module.exports.MsgRequestData = MsgRequestData

// const baseMsgRequestDataResponse = {};
// const MsgRequestDataResponse = {
//     encode(_, writer = Writer.create()) {
//         return writer;
//     },
//     decode(input, length) {
...
// module.exports.MsgRequestDataResponse = MsgRequestDataResponse
...
class MsgClientImpl {
    ...
    DeleteData(request) {
        ...
        //     const promise = this.rpc.request("shamba.geostats.geostats.Msg", "RequestData", data);
